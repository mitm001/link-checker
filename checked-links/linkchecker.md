...
```
jme-wiki/404.html
	ERROR	/jme-wiki/_/img/jme-logo.png
		Document root directory is not specified
	ERROR	/jme-wiki/docs/documentation.html
		Document root directory is not specified
	ERROR	/jme-wiki/wiki-contribution/wiki_admin.html
		Document root directory is not specified
	ERROR	/jme-wiki/wiki-ui/index.html
		Document root directory is not specified
...
jme-wiki/docs/core/shader/jme3_shadernodes.html
	...
	ERROR	https://github.com/jMonkeyEngine/jmonkeyengine/blob/master/jme3-core/src/main/java/com/jme3/shader/UniformBinding.java
		Too Many Requests (HTTP error 429)
jme-wiki/docs/getting-started/build_from_sources.html
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-1-inputmapper-based-camera-movement/28703
		Too Many Requests (HTTP error 429)
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-2-inputmapper-delegates/28710
		Too Many Requests (HTTP error 429)
...
jme-wiki/docs/core/util/sky.html
	...
	ERROR	https://github.com/jMonkeyEngine-Contributions/Lemur/wiki/Modules
		Too Many Requests (HTTP error 429)
jme-wiki/docs/getting-started/setting_up_netbeans_and_jme3.html
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-1-inputmapper-based-camera-movement/28703
		Too Many Requests (HTTP error 429)
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-2-inputmapper-delegates/28710
		Too Many Requests (HTTP error 429)
...
jme-wiki/docs/documentation.html
	...
	ERROR	https://hub.jmonkeyengine.org/t/uploading-pictures-and-changing-avatars-is-disabled/39520
		Too Many Requests (HTTP error 429)
jme-wiki/docs/getting-started/setting_up_jme3_in_eclipse.html
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-1-inputmapper-based-camera-movement/28703
		Too Many Requests (HTTP error 429)
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-2-inputmapper-delegates/28710
		Too Many Requests (HTTP error 429)
	...
	ERROR	https://hub.jmonkeyengine.org/t/effecttrack-and-audiotrack-editing-in-the-sdk/23378
		Too Many Requests (HTTP error 429)
jme-wiki/docs/getting-started/maven.html
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-1-inputmapper-based-camera-movement/28703
		Too Many Requests (HTTP error 429)
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-2-inputmapper-delegates/28710
		Too Many Requests (HTTP error 429)
...
jme-wiki/docs/logo.html
	...
	ERROR	https://hub.jmonkeyengine.org/t/effecttrack-and-audiotrack-editing-in-the-sdk/23378
		Too Many Requests (HTTP error 429)
jme-wiki/docs/getting-started/build_jme3_sources_with_netbeans.html
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-1-inputmapper-based-camera-movement/28703
		Too Many Requests (HTTP error 429)
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-2-inputmapper-delegates/28710
		Too Many Requests (HTTP error 429)
	...
	ERROR	https://hub.jmonkeyengine.org/t/effecttrack-and-audiotrack-editing-in-the-sdk/23378
		Too Many Requests (HTTP error 429)
jme-wiki/docs/getting-started/simpleapplication_from_the_commandline.html
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-1-inputmapper-based-camera-movement/28703
		Too Many Requests (HTTP error 429)
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-2-inputmapper-delegates/28710
		Too Many Requests (HTTP error 429)
	...
	ERROR	https://hub.jmonkeyengine.org/t/effecttrack-and-audiotrack-editing-in-the-sdk/23378
		Too Many Requests (HTTP error 429)
jme-wiki/docs/getting-started/features.html
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-1-inputmapper-based-camera-movement/28703
		Too Many Requests (HTTP error 429)
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-2-inputmapper-delegates/28710
		Too Many Requests (HTTP error 429)
...
jme-wiki/docs/core/input/mouse_picking.html
	...
	ERROR	https://hub.jmonkeyengine.org/t/effecttrack-and-audiotrack-editing-in-the-sdk/23378
		Too Many Requests (HTTP error 429)
jme-wiki/docs/getting-started/jme3_source_structure.html
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-1-inputmapper-based-camera-movement/28703
		Too Many Requests (HTTP error 429)
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-2-inputmapper-delegates/28710
		Too Many Requests (HTTP error 429)
...
jme-wiki/docs/sdk/development/model_loader.html
	...
	ERROR	https://hub.jmonkeyengine.org/t/effecttrack-and-audiotrack-editing-in-the-sdk/23378
		Too Many Requests (HTTP error 429)
jme-wiki/docs/getting-started/requirements.html
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-1-inputmapper-based-camera-movement/28703
		Too Many Requests (HTTP error 429)
	ERROR	http://hub.jmonkeyengine.org/t/lemur-gems-2-inputmapper-delegates/28710
		Too Many Requests (HTTP error 429)
...
jme-wiki/docs/tutorials/beginner/hellovector.html
	...
	ERROR	https://hub.jmonkeyengine.org/t/effecttrack-and-audiotrack-editing-in-the-sdk/23378
		Too Many Requests (HTTP error 429)
jme-wiki/tutorials/scenegraph/assets/player/KeynoteDHTMLPlayer.html
	ERROR	http://www.apple.com/en/feedback/iworkcom.html
...
jme-wiki/docs/tutorials/how-to/modeling/blender/makehuman_blender_ogrexml_toolchain.html
	...
	ERROR	https://youtu.be/jHgAgTWIers?list=PLv6qR9TGkz8RcUr-fOHI2SksWA4BAU9TS
		Too Many Requests (HTTP error 429)
jme-wiki/tutorials/math/assets/player/KeynoteDHTMLPlayer.html
	ERROR	http://www.apple.com/en/feedback/iworkcom.html
		Not Found (HTTP error 404)
...
jme-wiki/docs/tutorials/how-to/java/read_graphic_card_capabilites.html
	...
	ERROR	https://youtu.be/jHgAgTWIers?list=PLv6qR9TGkz8RcUr-fOHI2SksWA4BAU9TS
		Too Many Requests (HTTP error 429)
jme-wiki/wiki-contribution/wiki_translation.html
	ERROR	https://github.com/
		Too Many Requests (HTTP error 429)
...
jme-wiki/docs/tutorials/how-to/java/swing_canvas.html
	...
	ERROR	https://youtu.be/jHgAgTWIers?list=PLv6qR9TGkz8RcUr-fOHI2SksWA4BAU9TS
		Too Many Requests (HTTP error 429)
jme-wiki/wiki-ui/prerequisites.html
	ERROR	https://github.com/creationix/nvm
		Too Many Requests (HTTP error 429)
jme-wiki/wiki-contribution/emoji.html
	ERROR	https://github.com/twitter/twemoji
		Too Many Requests (HTTP error 429)
jme-wiki/wiki-contribution/atom_editor.html
	ERROR	https://github.com/
		Too Many Requests (HTTP error 429)
jme-wiki/wiki-contribution/wiki_admin.html
	ERROR	https://github.com/jMonkeyEngine/jmonkeyengine
		Too Many Requests (HTTP error 429)
	ERROR	https://github.com/jMonkeyEngine/wiki-ui
		Too Many Requests (HTTP error 429)
	ERROR	https://github.com/mitm001/link-checker/blob/abddf3d5012b90186ae485073a8c1aaf15a3c447/.github/workflows/main.yml#L25
		Too Many Requests (HTTP error 429)
	ERROR	https://github.com/mitm001/link-checker/blob/master/.github/workflows/main.yml
		Too Many Requests (HTTP error 429)
jme-wiki/wiki-contribution/wiki_contributor.html
	ERROR	https://github.com/
		Too Many Requests (HTTP error 429)
```
